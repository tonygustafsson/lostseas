  ...
  <DefaultLayout>
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <p className="mb-4">
        ...
        perhaps sell of some barter goods. You can also buy medicine that you
        can give to your crew members to increase their health.
      </p>
      ...
      <p className="mb-4">
        ...
        per week. You and your crew won&apos;t die however, but they will refuse
        to travel any longer. You&apos;ll be stranded until you can buy more
        food and water.
      </p>
      ...
      <p className="mb-4">
        If you lose in battle, one of your ships might be sunk. If you only have
        one ship you are safe. Another reason for having many ships is to be
        able to have more crew members. And more crew members means harder
      ...
      <p className="mb-4">
        ...
        when they do boring stuff, like losing battles and traveling the great
        Caribbean Sea. When they are angry they will refuse to leave port with
        you.
      </p>

      <p className="mb-4">
        In order to fix this you have to please them, with food and drinks. You
        can visit the tavern and buy them some wine perhaps, or give them some
        of your gold.
      </p>

      <p className="mb-4">
        You are also responsible for their health. If the health goes to 0 they
        will not die, but they cannot follow you on your next journey. You can
        give them medicine after battles.
      </p>
      ...
      <p className="mb-4">
        ...
        The other method is to visit the tavern and speak to the sailors there,
        they often want to offer their services for free.
      </p>
      ...
      <p className="mb-4">
        ...
        level by 1. And if you fight your own nations ships it will be lowered
        by the same amount. Winning over neutral ships doesn&apos;t change your
      ...
      <p className="mb-4">
        ...
        this by attacking the enemy of the nation you want to be a citizen of.
        So if you want to be English, attack a lot of French ships! When you
        have won over more French ships than over English ships you can get
        yourself a citizenship. The title you receive depends on your level
        (which depends on how many more French ships than English ships you have
        destroyed).
      </p>

      <p className="mb-4">
        Just to make things clear: If you are a Spanish citizen and have
        attacked 50 French ships even though this isn&apos;t your enemy, and you
        have not attacked any English ships, you will be an english Admiral at
        once when you get yourself an english citizenship.
      </p>
      ...
      <p className="mb-4">
        The currency in this game is gold, for which you can buy and sell almost
        anything. You will mostly get money from looting ships at sea, but you
        can also sell your goods, gamble for it, or fight at the bar.
      </p>
      ...
      <p className="mb-4">
        ...
        It would be impossible to achieve anything if you couldn&apos;t save it
        in a safe place.
      </p>
      ...
      <p className="mb-4">
        ...
        account. There is however a small tax of 5 %. If you put in 100 dbl, you
        can only get 95 dbl back.
      </p>
      ...
      <p className="mb-4">
        ...
        more than 10 000 gold. The loans are free of charge, but you cannot add
        gold to your account until you have payed off your loan.
      </p>
      ...
      <p className="mb-4">
        ...
        itself, but depends on your activity in the game. A week will pass when
        you travel from a town to the Caribbean Sea.
      </p>
